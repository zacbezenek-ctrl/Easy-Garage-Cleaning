...
const adoptionErrors=new Set(['adoption_source_changed','adoption_receipt_invalid','adoption_receipt_conflict','adoption_receipt_identity_mismatch','adoption_readback_mismatch','schedule_adoption_operational_scope_invalid','schedule_adoption_vehicle_unavailable',
